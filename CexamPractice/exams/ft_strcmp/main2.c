...
/*   Updated: 2016/11/01 11:55:11 by bmiller          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
This technique is called personification.";
 ...
 ";
	...
	printf("strcmp:\n%d\n\n", strcmp(test3, test4));
	printf("ft_strcmp:\n%d\n\n", ft_strcmp(test3b, test4b));
	printf("First string: %s\n\n", test1);
	printf("Second string: %s\n\n", test2);
	printf("strcmp:\n%d\n\n", strcmp(test1, test2));
	printf("ft_strcmp:\n%d\n\n", ft_strcmp(test1b, test2b));
	printf("First string: %s\n\n", test5);
	printf("Second string: %s\n\n", test6);
	printf("strcmp:\n%d\n\n", strcmp(test5, test6));
	printf("ft_strcmp:\n%d\n\n", ft_strcmp(test5b, test6b));
	printf("First string: %s\n\n", test5);
	printf("Second string: %s\n\n", test1);
	printf("strcmp:\n%d\n\n", strcmp(test5, test1));
	printf("ft_strcmp:\n%d\n\n", ft_strcmp(test5b, test1b));
	printf("First string: %s\n\n", test8);
	printf("Second string: %s\n\n", test7);
	printf("strcmp:\n%d\n\n", strcmp(test8, test7));
	printf("ft_strcmp:\n%d\n\n", ft_strcmp(test8b, test7b));
}
